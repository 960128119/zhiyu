---
name: openzhiyu-api
description: "Zhiyu API documentation and reference. Use when working with Zhiyu backend APIs, AI, authentication, characters, messages, files, integrations, billing, or any server-side functionality. Triggers: API endpoints, backend routes, authentication, cloud API, integrations"
metadata:
  version: 0.5.1
---
...
When running Zhiyu desktop app, the local API server runs on port **3414** (fallback: **3515**):
