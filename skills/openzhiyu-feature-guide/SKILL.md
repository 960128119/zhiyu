...
description: "Use this when users ask about Zhiyu features, capabilities, or how to use it. Examples: 'Zhiyu 怎么用', '你能做什么', 'What can you do?', 'How does Zhiyu work?', 'Tell me about Zhiyu features', 'What platforms does Zhiyu support?', 'How do I use scheduled tasks?', 'What is Insights system?', 'How do I connect Telegram?', 'How to create automation?', '什么是 Zhiyu 事件?'
metadata:
  version: 0.5.1
---

> **Note:** If you haven't downloaded or installed Zhiyu yet, please refer to [Getting Started](https://openzhiyu.ai/docs/getting-started) for installation instructions.

# Zhiyu Product Features

Use this skill when users ask about Zhiyu features, usage, or capabilities. Provide accurate and easy-to-understand feature introductions and operation guides.

---

## What is Zhiyu

Zhiyu is a **Proactive AI Workspace** that understands your intent, orchestrates execution, and gets things done. It's not just another AI assistant—it's an innovative AI product that **senses business signals**, **orchestrates tasks autonomously**, and **tracks and validates results end-to-end**.

### Core Value Proposition

Zhiyu transforms how individuals and SMB teams work by:
...
### 🧠 Long-Term Memory
Clear recollection, never forgotten. Zhiyu builds persistent knowledge graphs that remember all important people, events, decisions, and context across sessions and time. Six months later, it still knows your commitments and preferences.

### 🎯 Noise Filtering
Tells you what you should act on. With hundreds of daily messages, Zhiyu replaces "information overload" with "priority signals." Filters 95% of noise, focusing your attention on the 5% that truly matters.

### ⚡ Powerful Engine
Intent understanding, automatic orchestration. When you say "Help me prepare an investor pitch," Zhiyu automatically understands intent, breaks it into multiple sub-tasks, invokes appropriate Skills, and chains execution.
...
### 🌍 Global Managers
Never miss a critical signal across time zones. Business runs 24/7 globally. Zhiyu filters time zone and language noise, capturing high-value opportunities while you sleep—wake up to a refined action list.
...
### 🚀 Founders & Sales
One person does the work of many, at scale. Zhiyu learns your communication style, automatically maintains hundreds of client relationships, follows up on leads, generates personalized proposals—never burns out.
...
2. Tell Zhiyu what you'd like it to help with
...
3. Once authorized, Zhiyu will automatically read your WhatsApp messages to generate long-term events. You can send messages in **"Starred Messages"** and AI will:

- Read and understand your message content
- Generate smart insights in Zhiyu
- You can converse with AI about these messages in Zhiyu
...
3. Once authorized, Zhiyu will automatically read your Telegram messages to generate long-term events on the Today page. You can send messages in **"Saved Messages"** and AI will:
...
2. Click **[Install Zhiyu]** on the authorization page to add to your workspace
...
3. Grant Zhiyu bot message permissions
...
> 💡 Stream mode means Zhiyu connects directly via WebSocket — no server or domain setup needed.
...
- Add the running app (Terminal, Node, or Zhiyu)
- Restart the app after granting permissions

> 💡 Your message data stays on your local device. Zhiyu only reads recent messages when you use it to generate insights.

---

## Desktop App

Zhiyu also offers a **desktop app** (macOS, Linux, and Windows) that provides a native local experience.
...
2. Run the installer — if Windows SmartScreen shows a warning, click **"More info"** then **"Run anyway"**. This is normal for new applications without a long code-signing reputation; Zhiyu is open-source and the code is publicly verifiable
...
Download the latest `.dmg` from [GitHub Releases](https://github.com/melandlabs/openzhiyu/releases/latest) and drag Zhiyu to your Applications folder.
...
When you first launch Zhiyu, the system may ask for a few permissions. Each one has a specific purpose — and **you can decline any of them**. Zhiyu will continue to work; you'll just lose the feature that requires that permission.

> **Privacy note:** Zhiyu processes data locally on your machine. Message content is never sent to third-party servers without your consent. [See our Privacy Policy →](https://app.openzhiyu.ai/privacy)

### macOS

| Permission | What it lets Zhiyu do | Can I decline? |
|---|---|---|
| **Full Disk Access** | Read your iMessage history from the local database so Zhiyu can surface important conversations in your Event feed | Yes — iMessage sync will be skipped |
| **Automation** | Send iMessages on your behalf when you ask Zhiyu to reply or notify someone | Yes — you'll receive drafts instead of automatic sends |
...
No special permissions are required on Linux. Zhiyu uses the standard desktop notification system (libnotify) to send alerts — if you have granted notification permissions to other apps, Zhiyu will use them automatically.

---

## Conversation Features

Just type your questions or requests in the chat box, and Zhiyu will help you find answers.
...
- **Web browsing** - Have Zhiyu browse for latest product info
- **New conversation creation** - Start new conversations around specific topics
- **History** - View conversation history
- **Source References** - See exactly which messages/conversations Zhiyu's answers come from, who was involved, and when they occurred
- **Artifacts** - Zhiyu can generate visual artifacts: mind maps, flowcharts, charts, roadmaps, surveys, and documents. Preview and interact with them directly in chat
- **File Analysis** - Upload files (PDF, images, etc.) in chat and ask Zhiyu to analyze, summarize, or extract information
...
You can also interact with Zhiyu directly through your connected messaging apps. Once connected, Zhiyu becomes your AI assistant within those platforms.
...
After connecting (e.g., Telegram), just send a message to **Saved Messages** and Zhiyu will respond naturally.

---

## Action Features

Zhiyu can generate action items for various scenarios.
...
- **Quick action suggestions** - Zhiyu suggests clickable quick actions
...
- **Message replies** - Click reply button in understanding detail view, Zhiyu will generate a reply

---

## Smart Insights

Zhiyu automatically analyzes your conversations to extract valuable information.
...
If you no longer want Zhiyu to access a connected platform, you can disconnect it at any time:
...
Once disconnected:
- Zhiyu will immediately stop reading new messages from that platform
...
Your data, your sovereignty. Zhiyu puts privacy and control first—you never need to trade data sovereignty for intelligence.

### 🔐 Our Privacy Principles

#### Local-First Architecture
Your original messages and files **stay on your device**. Zhiyu only accesses the minimum data needed to complete tasks—no unnecessary uploads.
- Raw data never leaves your local environment
- Only processed results are transmitted when needed
- Complete control over what data Zhiyu can access
...
Zhiyu gives you complete control over your data:
- **Access Controls**: Choose exactly which platforms and data Zhiyu can access
- **Data Retention**: Configure how long Zhiyu retains processed data
- **Delete Anytime**: Delete all your data at any time with one click
- **Export**: Export all your data in standard formats

We believe **privacy and intelligence aren't mutually exclusive**. You should never have to choose between powerful AI capabilities and data control. Zhiyu delivers both.

---

## FAQ

### Q: How do I use Zhiyu?

A: It's simple!
1. Start a conversation in Zhiyu
...
## Showcase: Zhiyu in Action

Real-world examples showing how Zhiyu works across different use cases.
...
I'm Zhiyu, your community assistant:
...
- Zhiyu website: https://openzhiyu.ai
- Zhiyu documents: https://openzhiyu.ai/docs
