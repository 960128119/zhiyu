---
title: "OpenZhiyu Memory System: Lifecycle, Vector Indexing, and Semantic Recall"
date: 2026-05-26
description: A source-level guide to OpenZhiyu memory domains, lifecycle compaction, embedding maintenance, vector backends, and cross-source semantic recall.
---

# OpenZhiyu Memory System

_Last verified against the current repository on June 10, 2026, including the
memory pipeline merged in
[PR #154](https://github.com/melandlabs/openzhiyu/pull/154)._

This document describes how OpenZhiyu stores, compacts, embeds, and retrieves
...
OpenZhiyu does not have one physical "memory database". The product-level
...
OpenZhiyu uses shared contracts at two levels:
...
OpenZhiyu keeps canonical records and vector indexes conceptually separate.
...
The embedding provider is shared through `@openzhiyu/rag`. It can use a cloud
...
See
[Local Embeddings and Vector Backends](https://github.com/melandlabs/openzhiyu/blob/main/docs/vector-backends.md)
...
configured vector backend. Chroma receives explicit embeddings; OpenZhiyu does
