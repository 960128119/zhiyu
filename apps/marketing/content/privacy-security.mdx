...
>
  ...
  >
    ...
    <span style={{ fontSize: "13.5px", color: "#64748b", lineHeight: 1.6 }}>
      Your data stays on your device. OpenZhiyu only accesses minimum required
      data.
    </span>
  </div>
  <div
...
You can view exactly when and why OpenZhiyu accessed your data. Every access is logged with:
...
<p align="center">
  <img src="/img/openzhiyu/audit.png" alt="OpenZhiyu Audit Log" />
</p>
