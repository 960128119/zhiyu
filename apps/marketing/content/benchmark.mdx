...
description: "OpenZhiyu memory system evaluation benchmarks — LoCoMo, LongMemEval, and Aloomi Harness performance data"
icon: "FaChartLine"
---

# Memory Benchmarks

OpenZhiyu's memory system is rigorously evaluated against academic and industry benchmarks to ensure industry-leading performance in real-world scenarios.
...
🔗 [GitHub Repository](https://github.com/melandlabs/openzhiyu/tree/main/benchmark/locomo)
...
🔗 [GitHub Repository](https://github.com/melandlabs/openzhiyu/tree/main/benchmark/longmemeval)
...
🔗 [GitHub Repository](https://github.com/melandlabs/openzhiyu/tree/main/benchmark/clbench)
