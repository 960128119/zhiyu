...
OpenZhiyu syncs with HubSpot/Salesforce, auto-updates your pipeline, generates personalized proposals, and manages follow-up sequences — never burns out.
...
> "I can now manage what used to require a full sales team. OpenZhiyu handles the follow-ups, the personalized outreach, the proposal generation — while I focus on closing deals."
...
Connect HubSpot in **Settings → Connectors** to sync your full pipeline. OpenZhiyu reads deal stages, owner assignments, and close dates — keeping your pipeline view always current without manual updates.

---

### Personalized Outreach Draft

OpenZhiyu drafts follow-ups that sound like you — not generic AI output. Use the **cold-email** and **revops** skills to generate personalized sequences at scale.

---

### Follow-Up Sequence Automation

Set up scheduled tasks for your outreach sequences. OpenZhiyu manages the cadence — weekly check-ins, post-demo follow-ups, competitive intel alerts — and drafts each message for your approval.

---

### Auto-Generated Proposal Draft

OpenZhiyu compiles context from past conversations, HubSpot deal data, and your notes into structured proposal drafts. Save hours of manual writing and ensure every proposal reflects what the client actually discussed.

---

## Tracking Your Pipeline

OpenZhiyu's tracking panel shows pipeline sync executions, outreach messages sent, and proposal drafts generated — giving you full visibility into your AI-powered sales operations.
...
Open OpenZhiyu and paste this:

```
Please help me set up my sales automation workflow.

1. Connect HubSpot in Settings → Connectors so OpenZhiyu can read my pipeline (deals, stages, owners, close dates)
...
OpenZhiyu will automatically create the scheduled tasks for you!
...
3. Complete the OAuth flow to authorize OpenZhiyu access
...
- OpenZhiyu reads your communication patterns and mirrors your tone in every draft
...
- Deals auto-advance in OpenZhiyu's Focus view as they progress in HubSpot
