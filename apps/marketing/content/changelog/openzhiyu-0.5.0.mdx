...
Two powerful new skills join the OpenZhiyu arsenal:
...
- OpenZhiyu rebrand completed across all packages, README, and i18n
...
- Homebrew cask formula for macOS installation via `brew install --cask openzhiyu`
