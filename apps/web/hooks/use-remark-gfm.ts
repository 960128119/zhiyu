  ...
  loadPromise = import("remark-gfm")
    .then((mod) => {
      ...
      if (typeof original !== "function") {
        console.warn("[Zhiyu] remark-gfm is disabled");
        cachedPlugin = null;
        return null;
      }
        ...
        try {
          ...
          if (
            ...
            try {
              ...
              console.warn(
                "[Zhiyu] remark-gfm plugin error, GFM features disabled:",
                err,
              );
              return undefined;
            }
    ...
    .catch((err) => {
      console.warn(
        "[Zhiyu] remark-gfm load failed (browser may not support regex lookbehind), GFM features disabled:",
        err,
      );
      cachedPlugin = null;
      return null;
