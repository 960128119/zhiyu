...
import { autoCleanupOldMessages } from "@openzhiyu/indexeddb/client";
 ...
 * @param assistantName - Assistant name, used to replace "openzhiyu" in copy
...
export function useInsightRefresh(
  ...
  // Assistant name
  const name = assistantName || "openzhiyu";
