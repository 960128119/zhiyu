const PREVIEW_SCROLL_FIX_ATTR = "data-openzhiyu-preview-scroll-fix";
const PREVIEW_SNAPSHOT_CLAMP_ATTR = "data-openzhiyu-preview-snapshot-clamp";
const PREVIEW_PAGE_FLOW_ATTR = "data-openzhiyu-preview-page-flow";
