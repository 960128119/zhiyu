 ...
 *
 * This module re-exports the WhatsAppAdapter from @openzhiyu/integrations/whatsapp
...
import { WhatsAppAdapter as BaseWhatsAppAdapter } from "@openzhiyu/integrations/whatsapp";
...
export type {
  WhatsAppDialogInfo,
  WhatsAppUserInfo,
} from "@openzhiyu/integrations/whatsapp";
export { activeAdapters } from "@openzhiyu/integrations/whatsapp";

// Re-export conversation store
export { WhatsAppConversationStore } from "@openzhiyu/integrations/whatsapp";

// Re-export client registry
export { WhatsAppClientRegistry } from "@openzhiyu/integrations/whatsapp/client-registry";
