...
export function joinPath(...paths: string[]): string {
	// Keep runtime path segments opaque to Next.js output tracing. Static
	// evaluation of a variadic join can otherwise widen to the entire home dir.
	return Reflect.apply(join, undefined, paths);
}
