...
> = {
  ...
  telegram: () => import("@openzhiyu/integrations/telegram"),
  whatsapp: () => import("../integrations/whatsapp"),
  teams: () => import("../integrations/teams"),
  facebook_messenger: () =>
    import("@openzhiyu/integrations/facebook-messenger"),
  linkedin: () => import("@openzhiyu/integrations/linkedin"),
  instagram: () => import("@openzhiyu/integrations/instagram"),
  google_calendar: () => import("@openzhiyu/integrations/calendar"),
  outlook_calendar: () => import("@openzhiyu/integrations/calendar"),
  imessage: () => import("../integrations/imessage"),
  feishu: () => import("@openzhiyu/integrations/feishu"),
  dingtalk: () => import("@openzhiyu/integrations/dingtalk"),
  gmail: () => import("../integrations/gmail"),
  rss: () => import("@openzhiyu/rss"),
  jira: () => import("../integrations/jira"),
  linear: () => import("../integrations/linear"),
  google_docs: () => import("@openzhiyu/integrations/google-docs"),
  hubspot: () => import("@openzhiyu/integrations/hubspot"),
  notion: () => import("@/lib/files/notion"),
  qqbot: () => import("@openzhiyu/integrations/qqbot"),
};
