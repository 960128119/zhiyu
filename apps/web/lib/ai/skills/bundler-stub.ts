...
async function getBundledSkillsPath(): Promise<string | null> {
  ...
  if (process.env.TAURI_MODE === "1" || process.env.IS_TAURI === "true") {
    ...
    if (isWindows) {
      ...
      // skills are at openzhiyu/_up_/_up_/_up_/skills
      // go up 5 from apps/web/ to reach openzhiyu/, then _up_/_up_/_up_/skills
      possiblePaths.push(
      ...
      possiblePaths.push(
        ...
        "/Applications/openzhiyu.app/Contents/Resources/skills",
        "/Applications/openzhiyu.app/Contents/Resources/_up_/_up_/_up_/skills",
      );
    } else {
      // Linux: resource_dir/_up_/_up_/_up_/skills (e.g. /usr/lib/openzhiyu/_up_/_up_/_up_/skills)
      possiblePaths.push(
        join(execDir, "..", "lib", "openzhiyu", "_up_", "_up_", "_up_", "skills"),
        join("/usr", "lib", "openzhiyu", "_up_", "_up_", "_up_", "skills"),
        join(execDir, "_up_", "_up_", "_up_", "skills"),
      );
    }
