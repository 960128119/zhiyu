...
export function createChatInsightTool(session: Session) {
  return tool(
    ...
    [
      ...
      "- Examples:",
      "  ❌ BAD: keyword='openzhiyu PR feature development' (too specific, hard to match)",
      "  ✅ GOOD: keyword=['openzhiyu', 'PR', 'feature', 'development'] (multiple keywords)",
      ...
      "- 'openzhiyu PR status' → keyword=['openzhiyu', 'PR', 'pull request'], days=30, searchMode='basic'",
          ...
          message:
            paginatedInsights.length > 0
              ...
              : notFound
                ...
                : "openzhiyu has not yet completed your history message aggregation, please add more integrations and try again later",
