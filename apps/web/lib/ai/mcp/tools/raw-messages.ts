  ...
  return [
    ...
    tool(
      ...
      [
        ...
        "- Examples:",
        "  ❌ BAD: keywords=['openzhiyu PR feature'] (too specific, won't match)",
        "  ✅ GOOD: Try keywords=['PR'], then keywords=['openzhiyu'], then keywords=['feature'] (multiple searches)",
        "",
    ...
    tool(
      ...
      [
        ...
        "",
        "**Usage Examples:**",
        "- 'Search my messages for openzhiyu' → keywords=['openzhiyu']",
        "- 'Search last 7 days for meetings' → keywords=['meeting'], days=7",
