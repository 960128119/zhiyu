  ...
  return [
    ...
    tool(
      ...
      [
        ...
        "- Examples:",
        "  ❌ BAD: keywords=['Zhiyu PR feature'] (too specific, won't match)",
        "  ✅ GOOD: Try keywords=['PR'], then keywords=['Zhiyu'], then keywords=['feature'] (multiple searches)",
        "",
    ...
    tool(
      ...
      [
        ...
        "",
        "**Usage Examples:**",
        "- 'Search my messages for Zhiyu' → keywords=['Zhiyu']",
        "- 'Search last 7 days for meetings' → keywords=['meeting'], days=7",
