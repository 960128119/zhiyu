  ...
  return [
    ...
    tool(
      ...
      [
        ...
        "   User: 'A demo of Zhiyu's features, need to show scenario-based features'",
        "   Assistant: 'Got it, I'll create a todo item to track this'",
        "   ",
        "   CORRECT createInsight call:",
        "   - title: 'Prepare client product demo'",
        "   - description: 'Need to prepare Zhiyu scenario-based feature demo for client'",
        "   - details: [",
        ...
        "     {content: 'A demo of Zhiyu features, need to show scenario-based features', person: 'User'},",
    ...
    tool(
      ...
      `${[
        ...
        "- User says: 'Update progress, Zhiyu shipped 10 bugs today'",
        ...
        "  details: [{content: 'Zhiyu shipped 10 bugs today'}],",
        "  title: 'Daily sync team progress update | Zhiyu shipped 10 bugs',",
        "  description: 'Daily sync team member progress. Latest: Zhiyu shipped 10 bugs today'",
        "}}",
