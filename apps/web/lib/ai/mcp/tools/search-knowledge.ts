  ...
  return [
    ...
    tool(
      ...
      [
        ...
        "- Examples:",
        "  ❌ BAD: query='openzhiyu PR feature new' (too specific, won't match)",
        "  ✅ GOOD: Try query='PR', then query='openzhiyu', then query='feature', then query='new' (multiple searches)",
        "",
        "Examples:",
        ...
        "- 'openzhiyu PR feature progress' → Try query='PR', then query='openzhiyu', then query='feature' (multiple searches)",
        "",
