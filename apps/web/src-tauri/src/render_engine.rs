...
/// This checks both the legacy path (~/.openzhiyu/render-engines/office/installed.json)
...
/// Check the legacy install location (~/.openzhiyu/render-engines/office/installed.json)
