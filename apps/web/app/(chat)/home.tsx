...
export function Home() {
  ...
  /** Chat page reads send parameter from URL, automatically sends that message after mounting (e.g., onboarding "Talk with Zhiyu") */
  ...
  function getPageContent() {
    ...
    const leftPanel = isInboxPage ? (
      ...
      <AgentBriefPanel key="brief-panel" hideHeader={true} embedInCard={true} />
    ) : (
