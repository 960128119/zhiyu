...
import * as botQueries from "@/lib/db/bot-queries";
import * as insightQueries from "@/lib/db/insight-queries";
import * as sessionContext from "@/lib/session/context";
import type { InsightSettings } from "@/lib/db/schema";

// Mock dependencies
vi.mock("@/lib/db/bot-queries");
vi.mock("@/lib/db/insight-queries");
vi.mock("@/lib/session/context");
vi.mock("@/lib/cache/insight");

const dbQueries = { ...botQueries, ...insightQueries };
