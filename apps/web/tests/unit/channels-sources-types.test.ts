 ...
 *
 * Tests for utility functions in @openzhiyu/integrations/channels/sources/types
 */
import { describe, test, expect } from "vitest";
import type { ExtractedMessageInfo } from "@openzhiyu/shared";

describe("isEmptyMessage", async () => {
  const { isEmptyMessage } =
    await import("@openzhiyu/integrations/channels/sources/types");
