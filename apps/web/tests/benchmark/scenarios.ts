...
export const BENCHMARK_SCENARIOS: BenchmarkScenario[] = [
  ...
  },
  {
    ...
    description:
      "User B (Founder) missed a message from a VC 2 weeks ago. openzhiyu should surface this as a rescued opportunity.",
    category: "P4",
    priority: "P0",
    userProfile: {
      name: "User B",
  ...
  },
  {
    ...
    description:
      "User C receives a Slack message while on WeChat. openzhiyu should suggest drafting a reply without switching apps.",
    category: "Q1",
    priority: "P2",
    userProfile: {
      name: "User C",
  ...
  },
  {
    ...
    description:
      "User A asks for X in Group 1. User B offers X in Group 2. openzhiyu should suggest connecting them.",
    category: "P5",
    priority: "P1",
    userProfile: {
      name: "User Me",
  ...
  },
  {
    ...
    description:
      "User receives a long meeting transcript. openzhiyu should extract action items and summary.",
    category: "Q3",
    priority: "P2",
    userProfile: {
      name: "User Me",
  ...
  },
  {
    ...
    description:
      "User A asks 'Can we meet?'. openzhiyu should suggest 'Send Calendly' or 'Propose Slots'.",
    category: "Q4",
    priority: "P2",
    userProfile: {
      name: "User Me",
  ...
  },
  {
    ...
    description:
      "User sees a message about a potential synergy. openzhiyu should identify it as a partnership lead.",
    category: "P2",
    priority: "P1",
    userProfile: {
      name: "User Me",
  ...
  },
  {
    ...
    description:
      "User sends the same 'Weekly Report' every Friday. openzhiyu should suggest automating it.",
    category: "Q2",
    priority: "P2",
    userProfile: {
      name: "User Me",
  ...
  // Q4 Variations
  {
    ...
    description: "openzhiyu suggests creating a ticket from a bug report.",
    category: "Q4",
    priority: "P2",
    userProfile: { name: "User Me", email: "me@example.com" },
    messages: [
  ...
  },
  {
    ...
    description: "openzhiyu suggests drafting an intro email.",
    category: "Q4",
    priority: "P2",
    userProfile: { name: "User Me", email: "me@example.com" },
    messages: [
  ...
  // Time+People+Context Q category variations (Executive/Team scenarios)
  {
    ...
    description:
      "Executive has weekly 1:1s with 5 direct reports. openzhiyu should aggregate prep materials.",
    category: "Q1",
    priority: "P1",
    userProfile: {
      name: "User Me",
  ...
  },
  {
    ...
    description:
      "Team lead runs weekly sync every Monday. openzhiyu should auto-generate agenda from last week's threads.",
    category: "Q2",
    priority: "P1",
    userProfile: {
      name: "User Me",
  ...
  },
  {
    ...
    description:
      "It's end of quarter. openzhiyu should suggest scheduling OKR review with team.",
    category: "Q4",
    priority: "P1",
    userProfile: {
      name: "User Me",
  ...
  },
  {
    ...
    description:
      "Executive coordinates between 3 teams on a shared project. openzhiyu should consolidate updates.",
    category: "Q1",
    priority: "P2",
  ...
  },
  {
    ...
    description:
      "Senior exec does monthly skip-level 1:1s. openzhiyu should track and remind.",
    category: "Q2",
    priority: "P2",
