...
export function SidePanelShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex h-full w-full min-h-0 min-w-0 overflow-visible">
      <div
        className={cn(
          "content-area-card relative min-w-0 min-h-0 overflow-hidden flex flex-col shadow-[0_1px_2px_rgba(24,34,45,0.04)]",
      ...
      {hasSidePanel && sidePanel && (
        <div
          className={cn(
            ...
            "transition-[width,min-width,max-width] duration-200",
