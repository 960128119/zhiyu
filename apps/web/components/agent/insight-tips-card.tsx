 ...
 * Shows random tips in empty state, helping users understand openzhiyu's features and value
 */
    ...
    () => [
      ...
      },
      {
        ...
        content: t(
          ...
          "openzhiyu organizes related conversations and commitments under each person\nImportant relationships don't rely on memory",
        ),
      },
      {
        id: "cross-language",
        ...
        content: t(
          ...
          "openzhiyu can help you understand and translate before replying\nReducing unnecessary back-and-forth",
        ),
      },
      {
        ...
        content: t(
          ...
          "openzhiyu generates next-step suggestions for Insight events\nWhether to act is always up to you",
        ),
      },
    ],
    [t],
