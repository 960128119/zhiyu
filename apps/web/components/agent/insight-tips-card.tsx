 ...
 * Shows random tips in empty state, helping users understand Zhiyu's features and value
 */
    ...
    () => [
      ...
      },
      {
        ...
        content: t(
          ...
          "Zhiyu organizes related conversations and commitments under each person\nImportant relationships don't rely on memory",
        ),
      },
      {
        id: "cross-language",
        ...
        content: t(
          ...
          "Zhiyu can help you understand and translate before replying\nReducing unnecessary back-and-forth",
        ),
      },
      {
        ...
        content: t(
          ...
          "Zhiyu generates next-step suggestions for Insight events\nWhether to act is always up to you",
        ),
      },
    ],
    [t],
