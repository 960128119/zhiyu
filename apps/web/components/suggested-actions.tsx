...
export function getAllDefaultSuggestions(
  ...
  return [
    {
      id: "wechatDigest",
      title: t("common.suggestedCards.wechatDigest.title"),
      emoji: "",
      type: "role_based" as const,
      reasoning: "Sync and summarize recent WeChat messages",
      related_insight_ids: [],
    },
    {
      id: "memoryReview",
      title: t("common.suggestedCards.memoryReview.title"),
      emoji: "",
      type: "role_based" as const,
      reasoning: "Review recent memories and pending follow-ups",
      related_insight_ids: [],
    },
    {
      id: "stockWorkshop",
      title: t("common.suggestedCards.stockWorkshop.title"),
      emoji: "",
      type: "role_based" as const,
      reasoning: "Create a daily A-share research workshop",
      related_insight_ids: [],
    },
    {
      id: "followUp",
      title: t("common.suggestedCards.followUp.title"),
      emoji: "",
      type: "role_based" as const,
      reasoning: "Extract concrete follow-up tasks from conversations",
      related_insight_ids: [],
    },
  ];
}
