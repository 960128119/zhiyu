...
import { UserMenuFullscreen } from "@/components/user-menu-fullscreen";
...
export function AppSidebar() {
  ...
  const [plan] = useState<string | null>("free");
  ...
  }, [categoryStats, totalCategoryStats, activeCategories]);
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && !isMobile && !isSidebarMinimal) {
      const saved = localStorage.getItem("openzhiyu-sidebar-collapsed-v2");
      if (saved !== null) {
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && !isMobile && isMounted) {
      localStorage.setItem(
        "openzhiyu-sidebar-collapsed-v2",
        String(isCollapsed),
      );
    }
  ...
  const desktopOffsetClass = effectiveCollapsed ? "md:ml-16" : "md:ml-60";
  const desktopWidthClass = effectiveCollapsed ? "md:w-16" : "md:w-60";
  ...
  return (
    <>
      <div
        className={cn(
          "w-0 px-0 transition-[margin-left,width,padding] duration-300",
          desktopOffsetClass,
        )}
      >
        <div
          className={cn(
            "fixed left-0 top-0 overflow-hidden border-r border-sidebar-border transition-[width,transform,opacity] duration-300",
            isMobile
              ? "h-screen pb-[64px] safe-area-inset-bottom bg-background"
              : "hidden h-full bg-sidebar md:block",
        ...
        >
          <div className="flex flex-col h-full">
            ...
            >
              <div className="flex items-center justify-start w-full">
                {isInSettingsContext ? (
                  ...
                  <>
                    <div className="flex size-9 items-center justify-center rounded-md bg-white shadow-[0_1px_2px_rgba(24,34,45,0.08)]">
                      <Image
            ...
            {!isSidebarMinimal && (
              <div className="flex flex-1 flex-col overflow-y-auto p-2 pt-4">
                <nav className="flex flex-col gap-1.5 flex-shrink-0">
                  ...
                  {!isInSettingsContext && (
                    <>
                      {!isCollapsed && (
                        <div className="order-0 px-3 pb-1 text-[11px] font-medium text-muted-foreground">
                          工作台
                        </div>
                      )}
                      {navItems.map((item) => {
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <Button
                                  variant="ghost"
                                  className={cn(
                                    "order-1 w-full gap-2 px-3 py-2.5 h-auto rounded-md transition-colors",
                                    isCollapsed
                                      ? "justify-center"
                                      : "justify-start",
                                    isNewChatActive
                                      ? "bg-white text-[var(--product-cobalt)] shadow-[inset_3px_0_0_var(--product-cobalt)]"
                                      : "text-sidebar-foreground hover:bg-sidebar-hover hover:text-sidebar-hover-foreground",
                                  )}
                                  onClick={() => {
                                  ...
                                  title={
                                    isCollapsed ? t("nav.newChat") : undefined
                                  }
                                >
                                  <RemixIcon
                                    name="chat_ai"
                      ...
                      {!isCollapsed && (
                        <div className="order-4 mt-3 border-t border-sidebar-border px-3 pb-1 pt-4 text-[11px] font-medium text-muted-foreground">
                          资料与连接
                        </div>
                      )}

                      {/* Work Workshop - open-ended agent workspaces */}
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button
                              variant="ghost"
                              className={cn(
                                "order-2 w-full gap-2 px-3 py-2.5 h-auto rounded-md transition-colors",
                                pathname === "/workshop"
                                  ? "bg-white text-[var(--product-amber)] shadow-[inset_3px_0_0_var(--product-amber)]"
                                  : "text-sidebar-foreground hover:bg-sidebar-hover hover:text-sidebar-hover-foreground",
                                isCollapsed
                                  ? "justify-center"
                                  : "justify-start",
                              ...
                              aria-current={
                                pathname === "/workshop" ? "page" : undefined
                              }
                              asChild
                            >
                              <Link
                                href="/workshop"
                                aria-label="智能体车间"
                                title={isCollapsed ? "智能体车间" : undefined}
                                onClick={() => {
                                  if (isMobile) {
                                    setIsCollapsed(true);
                                    window.dispatchEvent(
                              ...
                              >
                                <RemixIcon
                                  name="store_3"
                                  size={SIDEBAR_NAV_ICON_SIZE}
                                  filled={pathname === "/workshop"}
                                  className={
                                    pathname === "/workshop"
                                      ? "text-[var(--product-amber)]"
                                      : ""
                                  }
                                />
                                {!isCollapsed && (
                      ...
                      {/* Knowledge Pipeline - external information ingestion and wiki grounding */}
                      {isNavVisible("workspace") && (
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button
                              variant="ghost"
                              className={cn(
                                "order-3 w-full gap-2 px-3 py-2.5 h-auto rounded-md transition-colors",
                                pathname === "/knowledge-pipeline"
                                  ? "bg-white text-[var(--product-jade)] shadow-[inset_3px_0_0_var(--product-jade)]"
                                  : "text-sidebar-foreground hover:bg-sidebar-hover hover:text-sidebar-hover-foreground",
                                isCollapsed
                                  ? "justify-center"
                                  : "justify-start",
                            ...
                            >
                              <Link
                                ...
                                aria-label="个人记忆"
                                title={isCollapsed ? "个人记忆" : undefined}
                                onClick={() => {
                                  if (isMobile) {
                                    setIsCollapsed(true);
                                    window.dispatchEvent(
                              ...
                              >
                                <RemixIcon
                                  name="database_2"
                                  size={SIDEBAR_NAV_ICON_SIZE}
                                  filled={pathname === "/knowledge-pipeline"}
                                  className={
                                    pathname === "/knowledge-pipeline"
                                      ? "text-[var(--product-jade)]"
                                      : ""
                                  }
                                />
                                {!isCollapsed && (
                      ...
                      {/* Quant - A-share research dashboard */}
                      {isNavVisible("workspace") && (
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button
                              variant="ghost"
                              className={cn(
                                "order-4 w-full gap-2 px-3 py-2.5 h-auto rounded-md transition-colors",
                                pathname === "/quant"
                            ...
                            >
                              <Link
                                href="/quant"
                                aria-label="量化"
                                title={isCollapsed ? "量化" : undefined}
                                onClick={() => {
                                  if (isMobile) {
                                    setIsCollapsed(true);
                                    window.dispatchEvent(
                              ...
                              >
                                <RemixIcon
                                  name="line_chart"
                                  size={SIDEBAR_NAV_ICON_SIZE}
                                  filled={pathname === "/quant"}
                                  className={
                                    pathname === "/quant" ? "text-primary" : ""
                                  }
                                />
                                {!isCollapsed && (
                                  <span
                      ...
                      {/* Content publisher - local social platform publishing tools */}
                      {isNavVisible("workspace") && (
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button
                              variant="ghost"
                              className={cn(
                                "order-5 w-full gap-2 px-3 py-2.5 h-auto rounded-md transition-colors",
                                pathname === "/content-publisher"
                                  ? "text-primary bg-sidebar-hover"
                                  : "text-sidebar-foreground hover:bg-sidebar-hover hover:text-sidebar-hover-foreground",
                                isCollapsed
                                  ? "justify-center"
                            ...
                            >
                              <Link
                                href="/content-publisher"
                                aria-label="发布"
                                title={isCollapsed ? "发布" : undefined}
                                onClick={() => {
                                  if (isMobile) {
                                    setIsCollapsed(true);
                                    window.dispatchEvent(
                              ...
                              >
                                <RemixIcon
                                  name="send_plane"
                                  size={SIDEBAR_NAV_ICON_SIZE}
                                  filled={pathname === "/content-publisher"}
                                  className={
                                    pathname === "/content-publisher"
                                      ? "text-primary"
                                      : ""
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button
                              variant="ghost"
                              className={cn(
                                "order-6 w-full gap-2 px-3 py-2.5 h-auto rounded-md transition-colors",
                                pathname === "/workspace"
                                  ? "text-primary bg-sidebar-hover"
                                  : "text-sidebar-foreground hover:bg-sidebar-hover hover:text-sidebar-hover-foreground",
                                isCollapsed
                            ...
                            >
                              <Link
                                href="/workspace"
                                aria-label="文件"
                                title={isCollapsed ? "文件" : undefined}
                                onClick={() => {
                                  if (isMobile) {
                                    setIsCollapsed(true);
                                    window.dispatchEvent(
