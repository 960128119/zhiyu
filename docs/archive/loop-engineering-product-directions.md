...
- It matches the current Zhiyu capabilities: chat, connectors, Loop, agent execution, WeChat and Feishu integrations
...
Zhiyu can become an AI Loop Workspace where users create long-running intelligent roles instead of one-off tasks.

The product should help users say:

> I want an agent to be responsible for this area over time.

Then Zhiyu turns that intent into:
