...
import type { Friend } from "@openzhiyu/integrations/channels";
...
/** Convert openzhiyu Messages to plain text (first version only supports text, images as placeholders) */
