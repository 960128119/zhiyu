const enUS = {
  common: {
    ...
    email: "Email",
    password: "Password",
    welcome: "Welcome to Zhiyu Alpha",
    more: "More",
    askopenzhiyu: "Ask Zhiyu",
    continue: "Continue",
    add: "Add",
    ...
    all: "All",
    create: "Create",
    chatSubTitle: "Where should we start today?",
    chatSubDescription:
      "Turn messages into memory, then give that memory to agents that keep working. Or just describe what you need now.",
    ...
    suggestedCards: {
      wechatDigest: {
        title: "Sync WeChat and summarize this week",
        description: "Extract summaries, follow-ups, and durable memories.",
      },
      memoryReview: {
        title: "Review recent memories and follow-ups",
        description: "Check extracted conclusions, sources, and confidence.",
      },
      stockWorkshop: {
        title: "Create a daily A-share review workshop",
        description: "Review the close and prepare tomorrow's watchlist.",
      },
      followUp: {
        title: "Find everything I need to follow up",
        description: "Identify requests, owners, timing, and next steps.",
      },
    },
    quickAuthPrimaryCta: "Connect an integration",
    quickAuthTitle: "Connect Zhiyu to your tools",
    quickAuthSubtitle:
    ...
    readyToChat: "You’re all set. Jump back into Zhiyu anytime.",
    ...
    suggestion:
      "If you have suggestions or ideas about using Zhiyu, we'd love to hear from you.",
    ...
    telegramBotHeadline: "Use Zhiyu Telegram Bot",
    telegramBotDescription:
      "Install the official Zhiyu Bot to surface understandings and run /insight, /ask, and /reply commands right inside Telegram.",
    openTelegramBot: "Open Zhiyu Bot in Telegram",
    unAuth:
    ...
    replyToneHint: "Used whenever Zhiyu drafts a reply for you.",
    ...
    aiSoulHeading: "Zhiyu Soul",
    aiSoulIntroDescription:
      "Shape Zhiyu's personality and how it works — so it feels like yours, not just anyone's assistant.",
    aiSoulHint:
    ...
    skillsSettings: {
      ...
      titleNew: "Skills",
      descriptionNew:
        "Provide pre-packaged and reusable best practices and tools for Zhiyu",
    ...
    creditsTopUp: {
      ...
      topUpDescription:
        "Purchase Zhiyu credits for AI conversations and features",
  ...
  connectors: {
    pageDescription:
      "Link your platforms or subscribe to content you care about — Zhiyu keeps watch so you don't have to.",
  },
  integrations: {
    description:
    ...
    feedsSectionDescription:
      "Pipe curated or custom RSS feeds into Zhiyu so Web3, finance, technology, AI, design, and hardware news stay in one stream.",
    ...
    customFeedDescription:
      "Paste any RSS/Atom/JSON feed URL. Zhiyu fetches these feeds, deduplicates entries, and surfaces them in your understanding feed.",
    ...
    importOpmlHint:
      "Only .opml files up to 2MB are accepted. Zhiyu processes the first 200 feeds per upload.",
  ...
  openzhiyu: {
    ...
    contextPrefix: "Zhiyu is currently focused on the following content:",
    thinking: "Zhiyu is thinking...",
    placeholder: "Ask anything about this report...",
    placeholderGeneral: "Ask Zhiyu anything about message management...",
  },
  bot: {
  ...
  insight: {
    ...
    attachments: {
      ...
      missingBlob: "We couldn't locate this file in Zhiyu storage.",
    ...
    discussWithopenzhiyu: "Discuss with Zhiyu",
    openChat: "Open Chat",
    closeChat: "Close Chat",
    openWorkspace: "Open Workspace",
    closeWorkspace: "Close Workspace",
    continueDiscussWithopenzhiyu: "Continue discussing with Zhiyu",
    newChat: "New Chat",
    chatHistory: "Chat History",
    focus: "Focus",
    ...
    tabs: {
      ...
      tips: {
        platformIntegration: {
          title: "Did you know?",
          content:
            "Most people switch between multiple platforms daily. Zhiyu brings them together in one controllable view.",
        },
        privacy: {
          title: "About Privacy",
          content:
            "Zhiyu only retains structured insights. Original messages are not stored long-term after processing.",
        },
        focus: {
          title: "About Focus",
          content:
        ...
        people: {
          title: "People",
          content:
            "Zhiyu organizes related communications and commitments under one person. Important relationships don't need to rely on memory.",
        },
        crossLanguage: {
          title: "Cross-Language Communication",
          content:
            "Zhiyu can help you understand and translate before replying, reducing unnecessary back-and-forth.",
        },
        actionSuggestions: {
          title: "Action Suggestions",
          content:
            "Zhiyu generates next-step suggestions for Insight events. Whether to execute is always your decision.",
        },
        random: "Random Tip",
      },
    },
  ...
  guide: {
    close: "Close guide",
    heading: "Welcome to Zhiyu",
    step: "Step",
    back: "Back",
    skip: "Skip",
    open: "Open welcome guide",
    summariesTitle: "Let Zhiyu surface the understandings for you",
    summariesBody:
      "Your latest highlights are ready. Tap “Show understandings” anytime to reopen this pane.",
    summariesEmpty:
      "Once Zhiyu ingests your inboxes, understandings land here. You can keep working while we gather context.",
    summariesCta: "View understandings",
    detailTitle: "Preview the full story before you act",
    detailBody:
      "Opening a card reveals Zhiyu' trace of why it matters, who is involved, and what needs your voice.",
    detailCta: "Keep going",
    replyTitle: "Reply as your AI assistant",
    replyBody:
      "Compose or tweak Zhiyu' draft, send with one tap, and we confirm once your message is delivered.",
  ...
  auth: {
    ...
    signInSubtitle:
      "Use your Zhiyu credentials or continue with Google to get back to your inbox.",
    ...
    forgotPasswordSubtitle:
      "Enter the email you used for Zhiyu and we'll send a reset link to your inbox.",
    ...
    signUpLink: "Sign Up",
    signUpTitle: "Create your Zhiyu account",
    ...
    resetSuccessBody:
      "You can now sign in to Zhiyu with your new password.",
    ...
    signInLink: "Log In",
    heroTitle: "Zhiyu is your conversation avatar",
    heroSubtitle:
    ...
    discordConnectDescription:
      "Select the Discord server where Zhiyu should triage and summarize channels. Be sure to invite the Zhiyu bot before continuing.",
    ...
    discordNoManageableGuilds:
      "We couldn't find any Discord servers you manage. Invite Zhiyu to your workspace and try again.",
    discordInviteReminder:
      "Invite the Zhiyu bot to your Discord server so it can read messages and keep understandings up to date.",
    discordInviteCta: "Invite Zhiyu Bot",
    ...
    outlookDes:
      "Authorize us to access your Outlook mailbox via IMAP/SMTP so Zhiyu can read and send emails for you.",
    outlookCalendarDes:
      "Connect Outlook Calendar so Zhiyu can track changes and help schedule or update events.",
    linkedinDes:
      "Authorize us to access your LinkedIn inbox so Zhiyu can summarize and help you reply faster.",
    twitterDes:
      "Authorize us to access your X account so Zhiyu can read and post tweets and reply to DMs in one place.",
    instagramDes:
      "Authorize us to access your Instagram DMs so Zhiyu can summarize and help you reply.",
    googleCalendarDes:
      "Authorize us to access your Google Calendar so Zhiyu can surface new and upcoming events and help you take action quickly.",
    googleDriveDes:
      "Connect Google Drive so Zhiyu can save files straight to your personal storage.",
    googleDocsDes:
      "Connect Google Docs so Zhiyu can watch document changes and draft updates for you.",
    notionDes:
      "Connect Notion to save files into your workspace and let Zhiyu learn from selected pages or databases.",
    messengerDes:
      "Connect a Facebook Page so Zhiyu can read and reply to Messenger conversations using your page access token.",
    whatsappDes:
      "Authorize us to access your WhatsApp messages so Zhiyu can summarize conversations and help you reply on time.",
    githubDes:
    ...
    feishuDes:
      "Connect Lark/Feishu with App ID and App Secret to chat with Zhiyu via WebSocket.",
    ...
    feishuConnectRestartDescTauri:
      "To ensure Lark/Feishu message listening works reliably, please fully quit and restart the Zhiyu desktop app",
    ...
    feishuBotDescription: "Chat with Zhiyu via Lark/Feishu",
    ...
    feishuStepsNote:
      "Note: If long connection is not shown here, try restarting Zhiyu",
    feishuSteps7:
    ...
    dingtalkBotDescription: "Chat with Zhiyu via DingTalk",
    dingtalkConnectRestartTitle: "DingTalk connected",
    dingtalkConnectRestartDescTauri:
      "Fully quit and restart the Zhiyu desktop app so DingTalk message listening stays reliable.",
    ...
    dingtalkSteps3:
      "After publishing, enter Client ID and Client Secret in Zhiyu and connect.",
    dingtalkSteps4:
      "Server deployments auto-start Stream; on desktop, restart the app after connecting.",
    qqbotDes:
      "Connect QQ with App ID and App Secret to chat with Zhiyu via WebSocket.",
    ...
    qqbotBotDescription: "Chat with Zhiyu via QQ",
    weixinLabel: "Weixin",
    weixinDes:
      "Scan the QR code in the page to sign in to Weixin and chat with Zhiyu via long polling.",
    ...
    imessageErrorPermission:
      "Full Disk Access permission is required to read iMessage database. Please add the current running application process (such as Terminal, Node, or Zhiyu) in System Settings > Privacy & Security > Full Disk Access, then restart the app and try again.",
    ...
    imessageDisplayNameHint:
      "This name will be used to identify your iMessage account in Zhiyu",
    imessageDataNote:
    ...
    slackAdminConfirmDesc:
      "You need to be a Slack workspace administrator to authorize this integration. Regular members cannot add Zhiyu to the workspace.",
    discordAdminConfirmTitle: "Discord Admin Required",
    discordAdminConfirmDesc:
      "You need to be a Discord server administrator to authorize this integration. Regular members cannot add Zhiyu to the server.",
  ...
  tour: {
    ...
    guest: {
      step1: {
        ...
        body: "Use this button to link Zhiyu with Slack, Telegram, Gmail, or more. Authorizing lets us pull the conversations you care about.",
      },
      step2: {
      ...
      step3: {
        ...
        body: "Zhiyu reads new conversations, builds daily understandings, and drafts replies so you can clear your inbox faster.",
      },
    },
    summary: {
      open: "Guided tour",
      openHelp: "See how Zhiyu organises your updates",
      step1: {
      ...
      step4: {
        title: "Ask Zhiyu anything",
        body: "Use the chat to ask questions like “What did I miss today?” or “Who mentioned the launch?”—Zhiyu reads your connected channels to answer.",
      },
      step5: {
      ...
      step6: {
        ...
        body: "Choose drafting language, people, and topics Zhiyu should prioritise—everything stays in sync with your settings.",
      },
      step7: {
  ...
  insightPreferences: {
    ...
    subtitle:
      "Tell Zhiyu how you prefer understandings to be generated so we can prioritize the messages and tone that matter most.",
    ...
    identity: {
      ...
      description:
        "Grounded in your onboarding responses so Zhiyu can stay aligned with your day-to-day tone and focus.",
      introDescription:
        "The more you share, the better Zhiyu understands what truly matters to you.",
      ...
      workEmpty:
        "You haven’t described your day-to-day work yet. Add it in onboarding so Zhiyu can stay in context.",
      ...
      workDescriptionHint:
        "Tell Zhiyu about yourself in your own words — your work, priorities, and how you spend your day.",
    ...
    roles: {
      ...
      description:
        "See which professional roles Zhiyu is using and add more overlays so understandings stay aligned with your responsibilities.",
      ...
      selectionDescription:
        "Pick the overlays Zhiyu should always consider. We’ll keep using survey responses and automatic detection on top of your selections.",
    ...
    focusPeopleDescription:
      "Zhiyu will use it as a reference when prioritizing",
  ...
  securityPrompt: {
    ...
    commitmentTitle: "Zhiyu's Commitment to Your Telegram Data",
    permissions: {
      ...
      sendMessagesDesc:
        "Zhiyu will send messages on your behalf in Telegram only with your explicit instruction to help you respond efficiently.",
      viewGroups: "View Groups & Contacts",
      viewGroupsDesc:
        "This helps Zhiyu understand your social network and intelligently identify communication context and mentions.",
    },
    principles: {
    ...
    learnMore: "Learn More: Zhiyu Privacy Policy →",
    stepsTitle: "Steps to Authorize Access",
    stepsDesc:
      "Before authorizing, please make sure you understand how Zhiyu protects your data.",
    step1: 'Click the "Connect" button below',
    step2: "You will be redirected to Telegram",
    step3: "Log in to your Telegram account",
    step4: "Authorize Zhiyu to access your Telegram data",
    step5: "You will be redirected back to Zhiyu",
    privacyNotice:
      "Privacy Notice: By clicking 'Connect', you agree to Zhiyu processing your Telegram data according to our privacy policy. Your data will be securely encrypted and used only to provide Zhiyu services.",
  ...
  telegram: {
    ...
    pendingMessage: "Binding your Zhiyu account…",
    success: {
      message:
        "Binding successful! You can now return to Telegram to use the Zhiyu bot.",
    },
    error: {
      missingToken:
    ...
    actions: {
      backToConsole: "Back to Zhiyu Console",
  ...
  whatsapp: {
    ...
    success: {
      message:
        "Binding successful! You can now return to WhatsApp to use the Zhiyu bot.",
    },
    error: {
      missingToken:
  ...
  discord: {
    ...
    successMessage:
      "Binding successful! You can now return to Discord to use the Zhiyu bot.",
    defaultRetryError:
      "Binding failed, please return to Discord and re-send /login.",
    backToConsoleBtn: "Return to Zhiyu Console",
    retryBtn: "Try Again",
  ...
  chat: {
    replySent: "Delivered. Zhiyu will monitor replies.",
    replyGenerating: "Zhiyu is shaping your twin reply...",
  ...
  rewards: {
    ...
    firstReply: {
      ...
      description:
        "Use Zhiyu to respond once and unlock automation controls.",
    },
  ...
  nav: {
    ...
    referralCardTitle: "Share Zhiyu with Friends",
  ...
  sidebar: {
    onboardingGuide: {
      ...
      resumeHint: "Click here to explore everything Zhiyu can do for you.",
      resumeHintImageAlt: "Onboarding hint",
      openMandatoryDebug: "Open new onboarding modal",
      collectInfo: {
        title: "Give Zhiyu context to work with",
        ...
        tooltip: {
          ...
          connectTelegram:
            "Connect Telegram so you can chat with Zhiyu directly in Telegram.",
          connectWhatsApp:
            "Connect WhatsApp so you can chat with Zhiyu directly in WhatsApp.",
          connectIMessage:
            "Connect iMessage so you can chat with Zhiyu directly in iMessage.",
          connectQQ:
            "Connect QQ so you can chat with Zhiyu directly in QQ.",
          connectFeishu:
            "Connect Lark/Feishu so you can chat with Zhiyu directly in Lark/Feishu.",
          linkPlatform:
            "Connect Slack, Gmail, Telegram and more. Zhiyu reads your conversations and surfaces what needs follow-up — before you have to ask.",
          addSubscription:
            "Add newsletters, RSS feeds, or research sources. Zhiyu monitors them continuously and brings you only what's relevant to your work.",
          uploadFile:
            "Upload docs, reports, or reference materials. Zhiyu uses them as context so it can give you more accurate, grounded responses.",
        },
      },
    },
    hint: {
  ...
  brief: {
    ...
    stats: {
      ...
      messageCountShort:
        "In the past 24 hours, Zhiyu helped you process {{messageCount}} information sources",
    },
  },
  agent: {
    toolbar: {
    ...
    panels: {
      ...
      workspacePanel: {
        ...
        emptyFilesHint: "Chat with Zhiyu to generate some files",
      ...
      scheduledJobsPanel: {
        ...
        tauriOnly:
          "Scheduled jobs are only available in the Zhiyu desktop app.",
        viewChat: "View Chat",
        output: "Output",
  ...
  plans: {
    ...
    pro: "Pro",
    proDesc:
      "Designed for professionals and high-intensity communication contexts. Significantly enhanced processing capabilities and longer memory cycles make Zhiyu your truly intelligent assistant that understands you.",
    team: "Team",
    teamDesc:
  ...
  affiliate: {
    ...
    heroSupporting:
      "Creators, community leads, and automation experts use Zhiyu to turn conversations into reliable revenue.",
    ...
    shareHint:
      "Add ?ref={{code}} to any Zhiyu URL to set the referral cookie automatically.",
    ...
    faq: {
      ...
      audience: {
        ...
        answer:
          "Content creators, community managers, and AI enthusiasts who love showcasing Zhiyu are welcome.",
      },
      tracking: {
    ...
    applyTitle: "Join the Zhiyu Partner Network",
    applySubtitle:
    ...
    applyNotesPlaceholder:
      "Where you'll share Zhiyu (e.g. Twitter, YouTube, newsletters, community groups).",
  ...
  payment: {
    ...
    activationNote:
      "Your benefits will appear in Zhiyu within a few moments. We'll let you know if we need anything else.",
    successChecklist1:
  ...
  settings: {
    ...
    profileDescription:
      "Update how your name and avatar appear across Zhiyu",
    ...
    profilePreviewDescription:
      "Your display name and avatar appear in Zhiyu notifications and sharing surfaces.",
    profileGuestTip:
    ...
    personalizationDescription:
      "Tell Zhiyu how you prefer understandings to be generated so we can prioritize the messages and tone that matter most.",
    rolesDescription:
      "Review detected roles, industries, and work context, then lock the identities Zhiyu should prioritize.",
    personalizationTabs: {
    ...
    basicSettingsDescription:
      "Configure Zhiyu basic settings, including the language for understanding and replies, and the understanding refresh frequency.",
    peopleDescription:
      "Tell Zhiyu who and what you follow — it'll prioritize them every time it tracks.",
    contextsDescription:
      "Choose your contexts — Zhiyu will automatically sort events into the right categories, so you can focus on what matters most.",
    ...
    topicsDescription: "Zhiyu will use it as a reference when prioritizing",
    ...
    avatarStateDescription:
      "Zhiyu' appearance automatically changes based on different states",
  ...
  onboarding: {
    ...
    mandatory: {
      ...
      profile: {
        title: "Help Zhiyu understand you",
      },
      mate: {
    ...
    industry: {
      ...
      subtitle: "Let Zhiyu understand your work context",
      otherPlaceholder: "Enter other industry",
    },
    role: {
      title: "Select your role",
      subtitle: "Help Zhiyu stay aligned with how you work",
    },
    size: {
    ...
    painPoints: {
      title: "How should Zhiyu organize your focus?",
      subtitle:
        "Select the focus contexts that matter. Zhiyu will automatically categorize events to help you easily switch focus modes.",
      ...
      templatesSubtitle:
        "Click an option and fill in the blanks so Zhiyu captures the exact signal you need",
      templatesHint:
        "Not sure what to write? Pick a template, fill it in, then refine it.",
      ...
      templates: {
        ...
        cards: {
          ...
          projectProgress: {
            ...
            example: "e.g., Track major milestones for the Zhiyu project",
          },
          pendingTasks: {
          ...
          teamAchievements: {
            ...
            example:
              "e.g., Capture Zhiyu launch highlights and user milestones",
          },
        },
        executiveUpdates: {
          ...
          helper:
            "Tell us who matters most and which angle Zhiyu should watch.",
          preview:
        ...
        keywordWatch: {
          ...
          helper:
            "Tell Zhiyu the keyword and the scope it should apply to.",
          preview:
            "Flag any conversation mentioning {{keyword}} that relates to {{context}}.",
          fields: {
            keyword: {
              label: "Keyword / phrase",
              placeholder: "e.g. Zhiyu 2.0",
            },
            context: {
        ...
        channelMonitor: {
          ...
          helper:
            "Name the channel and why it matters so Zhiyu stays vigilant.",
          preview:
        ...
        pendingReplies: {
          ...
          helper:
            "Who usually pings you and what deadline should Zhiyu enforce?",
          preview:
    ...
    integration: {
      ...
      footerNote:
        "You can go to the integration management page to authorize Zhiyu to access more of your content, such as RSS feeds and file uploads.",
    },
    hub: {
      title: "Meet Zhiyu",
      ...
      groups: {
        ...
        recommended: "Experience Zhiyu",
        explore: "Learn more",
      },
      steps: {
        setupProfile: {
          title: "Help Zhiyu Know You",
          desc: "The more you share, the better Zhiyu understands what truly matters to you",
          guideTitle: "Help Zhiyu Know You",
        },
        createFirstEvent: {
          title: "Create your first tracking",
          desc: "Add or sync an update so Zhiyu can start organizing for you",
          ...
          bullet3:
            "Once you have trackings, you can ask Zhiyu to analyze or suggest",
          popoverHint: "Choose how to create your first tracking",
          popoverSubtitle:
            "Tell Zhiyu what to track — it'll monitor updates and surface what matters.",
          actionAuthorizePlatform: "Auto Track",
          actionAuthorizePlatformDesc:
            "Connect your accounts — Zhiyu finds what's worth tracking, automatically",
          actionChatWithAI: "Chat with Zhiyu",
          actionChatWithAIDesc:
            "Chat or upload a file, and Zhiyu will turn it into a Tracking",
          createTrackingPrompt:
            "Use the openzhiyu-event-creator skill to create a tracking that reminds me to drink water every hour",
        },
        openzhiyuFirstTask: {
          title: "Let Zhiyu do your first task",
          desc: "Ask about an event or give a task to experience Zhiyu's help",
          guideTitle: "Let Zhiyu do your first task",
          bullet1:
            'Click "Ask Zhiyu" on an event card and enter your question',
          bullet2:
            "Ask Zhiyu to summarize, draft a reply, or suggest next steps",
          bullet3:
            "Replies are based on full context of that event, not generic answers",
          popoverSubtitle:
            "Tell Zhiyu what to do — it'll help you get things done.",
          tryIt: "Try it",
          action1Title: "Draft a Message",
          action1Desc:
            "Tell Zhiyu what you want to say — she'll make it professional, warm, and ready to send.",
          action1Prompt:
            "Help me draft a message to my investor — let them know our Series A is progressing well and suggest a sync next week.",
          action2Title: "Co-create with Zhiyu",
          action2Desc:
            "Share what's on your mind — Zhiyu thinks alongside you and turns scattered ideas into something tangible.",
          action2Prompt:
          ...
          action3Desc:
            "Big goals stall without structure. Describe what you're working toward — Zhiyu breaks it into clear, ownable next steps.",
          action3Prompt:
          ...
          action4Desc:
            "Content is your most durable asset. Tell Zhiyu your product and audience — she'll build a strategy with rhythm.",
          action4Prompt:
          ...
          action5Desc:
            "Great marketing ideas are one angle away. Tell Zhiyu what you're launching — she'll find the hook.",
          action5Prompt:
          ...
          action6Desc:
            "Structure is persuasion. Describe your topic and audience — Zhiyu builds the skeleton so you focus on the story.",
          action6Prompt:
          ...
          action7Desc:
            "The AI space moves fast. Zhiyu filters the noise and surfaces only the signals worth your attention.",
          action7Prompt:
            "What's worth knowing in AI today? Give me a quick briefing.",
          action8Title: "What Can Zhiyu Do?",
          action8Desc:
            "Not sure how to use Zhiyu? This is your starting point — explore what she can do and find the workflow that fits you best.",
          action8Prompt:
            "I'm an early-stage startup founder dealing with a ton of communication every day. What can Zhiyu do for me?",
        },
        updateEvents: {
        ...
        firstChat: {
          title: "Chat with Zhiyu via messaging apps",
          desc: "Not just in the app —\nchat with Zhiyu directly via Telegram, QQ, Lark/Feishu, iMessage, WhatsApp.\nAsk questions, track updates, get things done anywhere.",
          guideTitle: "Chat with Zhiyu via messaging apps",
          learnMoreLink: "Learn how to connect →",
          bullet1: "Send messages to Zhiyu in your connected messaging app",
          bullet2:
        ...
        exploreAgents: {
          ...
          desc: "With automations, just hand off the recurring stuff to Zhiyu — it runs automatically at the time you set, so it never slips your mind. Skills are like equipping Zhiyu with the right toolkit, helping it handle specific scenarios with greater precision and care.",
          descAutomation:
            "In Automation, you manage all your scheduled tasks.\nHand off anything you need to repeat or plan for later to Zhiyu — it runs them for you at the time you set.",
          descSkill:
            "In Skills, you give Zhiyu the right abilities for different scenarios.\nThese Skills help it handle specific tasks with better context and more precise execution.",
        ...
        exploreLibrary: {
          ...
          desc: "Library is where Zhiyu helps you collect and organize everything — notes and files from your Trackings, plus anything generated in your conversations.",
  ...
  agentAvatar: {
    ...
    colorPresetLabels: {
      ...
      "openzhiyu-original": "Zhiyu Original",
  ...
  toast: {
    ...
    serverStartFailed: "Zhiyu failed to start",
    serverStartError: "Zhiyu startup error",
    appStarting: "Zhiyu is starting...",
    appDownloading: "Zhiyu is updating...",
  },
  update: {
    titleNewVersion: "New Version Available",
    titleUpdateComplete: "Update Complete",
    description:
      "A new version of Zhiyu is available. Update now for the latest features and fixes.",
