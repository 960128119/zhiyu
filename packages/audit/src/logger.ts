 ...
 * Logs are written in JSONL format to ~/.openzhiyu/logs/audit.jsonl
 *
...
function getLogPaths() {
  ...
  const dir = join(homedir(), ".openzhiyu", "logs");
...
export const AUDIT_LOG_PATH = "~/.openzhiyu/logs/audit.jsonl";
